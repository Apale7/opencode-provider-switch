...
// DiagnosticEntityRef is the wire shape for DoctorIssue.source.
type DiagnosticEntityRef struct {
	Kind string `json:"kind"`
	Key  string `json:"key"`
	Path string `json:"path,omitempty"`
}

// DiagnosticTargetRef is the wire shape for DoctorIssue.target.
...
type AliasView struct {
	...
	TargetOrderMode      string            `json:"targetOrderMode"`
	CatalogMatch         bool              `json:"catalogMatch"`
}
...
type DoctorIssue struct {
	...
	Path             string               `json:"path,omitempty"`
	Source           *DiagnosticEntityRef `json:"source,omitempty"`
	Target           *DiagnosticTargetRef `json:"target,omitempty"`
	Reason           string               `json:"reason,omitempty"`
	AllowedActions   []string             `json:"allowedActions,omitempty"`
	Params           map[string]any       `json:"params,omitempty"`
...
type AutoAliasSettingsInput struct {
	Enabled bool `json:"enabled"`
}

// AutoAliasSettingsResult is the current global auto-alias setting.
type AutoAliasSettingsResult struct {
	Enabled bool `json:"enabled"`
}

// AliasLockInput upgrades an auto-generated alias to locked.
type AliasLockInput struct {
	Name string `json:"name"`
}
