...
/** Shared-field provider write contract. Group-owned fields live under defaultGroup (create only). */
export type ProviderUpsertInput = {
  ...
  autoAliasEnabled?: boolean
  /** Required on create; ignored on update. Same contract as ProviderGroupInput. */
...
export type AliasView = {
  ...
  autoGenerated?: boolean
  locked?: boolean
  targetOrderMode?: 'provider_priority' | 'custom' | string
...
export type ProviderGroupDeleteInput = {
  providerId: string
  groupId: string
  selections?: LifecycleSelection[]
  expectedRevision?: ConfigRevision
...
export type ProviderGroupRefreshModelsInput = {
  providerId: string
  groupId: string
}

export type ProviderGroupPingInput = {
  providerId: string
  groupId: string
  baseUrl?: string
  protocol?: ProviderProtocol
...
export type ProviderGroupSelectorInput = {
  provider: string
  group: string
}

export type ProviderGroupSelectorView = {
  provider: string
  group: string
}
